    ...
    <div class=" row-r">
        <div class="size-bord">
            <aside class="col-lg-2">
                ...
                <br><br>
                <a class="list-group-item list-access active-l" href="posts.php">
                        ...
                        <div class="cent">
                            ...
                            <div class="col-md-11">
                                <table class=" table-list ">
                                    ...
                                    <tr class="table-tr">
                                        <th class="table-th">حذف المنشور</th>
                                        <th class="table-th">تعديل</th>
                                        <th class="table-th">الوظيفة</th>
                                        <th class="table-th">تأريخ النشر</th>
                                        <th class="table-th">البريد الالكتروني</th>
                                        <th class="table-th">اسم الشركة</th>
                                    ...
                                    foreach ($res as $key=>$row){
                                       ...
                                       <?php echo
                                        "<td class='table-td'>".$row['ContentPost'].
                                            "<td class='table-td'>".$row['DatePost'].
                                            "<td class='table-td'>".$row['EmailOwnerPost'].
                                            "<td class='table-td'>" .$row['NameOwnerPost']
                                        ?>
