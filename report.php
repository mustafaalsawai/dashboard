    ...
    <div class=" row-r">
        <div class="size-bord">
            <aside class="col-lg-2">
                ...
                <a class="list-group-item list-access" href="indexs.php">
                ...
                <a class="list-group-item list-access active-l" href="reviews.php">
                    البلاغات
                        ...
                        <div class="cent">
                            ...
                            <div class="col-md-11">
                                <table class=" table-list ">
                                    ...
                                    <tr class="table-tr">
                                        <th class="table-th">حذف البلاغ</th>
                                        <th class="table-th">تعديل</th>
                                        <th class="table-th">المحتوى</th>
                                        <th class="table-th">تأريخ البلاغ</th>
                                        <th class="table-th">بريد المستخدم</th>
                                        <th class="table-th">بريد الشركة</th>
                                    ...
                                    foreach ($res as $key=>$row){
                                        ...
                                        <?php echo
                                            "<td class='table-td'>".$row['Content'].
                                            "<td class='table-td'>".$row['DateReport'].
                                            "<td class='table-td'>".$row['EmailOwnerReport'].
                                            "<td class='table-td'>" .$row['EmailReported']
                                        ?>
                                        <td class="table-td"><img src="<?php echo $row['Photo']?>"n class="rounded-circle amg-t" width="10%">
