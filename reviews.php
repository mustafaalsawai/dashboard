                        ...
                        <div class="cent">
                            ...
                            <div class="col-md-11">
                                <table class=" table-list ">
                                    ...
                                    <tr class="table-tr">
                                        <th class="table-th">حذف المراجعة</th>
                                        <th class="table-th">تعديل</th>
                                        <th class="table-th">المحتوى</th>

                                        <th class="table-th">عدد التقيم</th>
                                    ...
                                    foreach ($res as $key=>$row){
                                        ...
                                        <?php echo
                                            ...
                                            "<td class='table-td'>".$row['CounterStars'].
                                            "<td class='table-td'>".$row['DateReview'].
                                            "<td class='table-td'>".$row['EmailReviewed'].
                                            "<td class='table-td'>" .$row['NameOwnerReview']
                                        ?>
